...
export const metadata: Metadata = {
  title: "Chee Yee Lim's Web Applications Portfolio",
  description:
    "To show what I can build for you: interactive websites integrated with AI and data analytics, hosted on scalable cloud infrastructure.",
  openGraph: {
    title: "Chee Yee Lim's Web Applications Portfolio",
    description:
      "To show what I can build for you: interactive websites integrated with AI and data analytics, hosted on scalable cloud infrastructure.",
...
const applications = [
  {
    ...
    description:
      "Explore HDB resale flat transactions in Singapore with interactive maps, charts and predicted prices.",
    href: "/hdbresale",
